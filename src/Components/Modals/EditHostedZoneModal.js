...
const EditHostedZoneModal = ({ open, setOpen, Id, setReload }) => {
        ...
        >
          <Slide duration={400} direction="down">
            <div className="modalContainer  w-[30rem] bg-white shadow-md rounded-md border py-5">
              ...
              <div className="modalHeader text-2xl font-medium text-center">Edit Hosted Zone </div>
...
export default EditHostedZoneModal;
